      ...
      <CardBody className="flex flex-col">
        <div className="flex items-start">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-semibold text-gray-900 mb-1 truncate">{investor.name}</h3>
            <p className="text-sm text-gray-500 mb-2 truncate">Investor • {investor.totalInvestments || 0} investments</p>
        ...
        <div className="mt-3 flex justify-between items-center mt-auto pt-4">
          <div>
