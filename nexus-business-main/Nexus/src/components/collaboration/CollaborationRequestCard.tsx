...
export const CollaborationRequestCard: React.FC<CollaborationRequestCardProps> = ({
  ...
  // Since we use .populate('investorId') on the backend, this field now contains the user object
  // We cast it to 'any' here assuming your types might still expect a string, but in reality it's an object now.
  const investor: any = request.investorId; 
  ...
  // Handle both mock timestamps and MongoDB createdAt strings
